// /src/components/shopping/FashionModal.jsx
...
export default function FashionModal({
  ...
  onClose,
  onSubmit,
  title = "Fashion (Shopping Assistance)",
  subtitle = "Runway to ready-to-wear — curated styling & delivery",
  imageUrl = "/media/fashion.png",
  info = [
    "Tell us when/where — we’ll map the best boutiques.",
    "Share wishlist categories and pre-arrival arrangements.",
    "We’ll coordinate delivery and gift messaging too.",
  ],
}) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Fashion" className="h-full w-full object-cover opacity-70" />
