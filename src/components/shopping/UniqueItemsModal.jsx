// /src/components/shopping/UniqueItemsModal.jsx
...
export default function UniqueItemsModal({
  open,
  onClose,
  onSubmit,
  title = "Unique Items (Shopping Assistance)",
  subtitle = "One-of-a-kind & rare finds — sourcing & delivery",
  imageUrl = "/media/shopping-unique-items.png",
  info = [
    "Tell us when/where — we’ll plan a bespoke hunt.",
    "Share wishlist categories and pre-arrival arrangements.",
    "We coordinate delivery and gift messaging too.",
  ],
}) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Unique Items" className="h-full w-full object-cover opacity-70" />
