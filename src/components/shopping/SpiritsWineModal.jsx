// /src/components/shopping/SpiritsWineModal.jsx
...
export default function SpiritsWineModal({
  open,
  onClose,
  onSubmit,
  title = "Spirits & Wine (Shopping Assistance)",
  subtitle = "Concierge shopping, tastings, and pre-arrival setups",
  imageUrl = "/media/shopping-spirits-wine.png",
  info = [
    "Tell us where and when you’ll shop — we’ll plan the route.",
    "Add wishlist categories and pre-arrival arrangements.",
  ...
  const [form, setForm] = useState({
    ...
    deliveryDateTime: "", // datetime-local
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        wishlist: form.wishlist,        // array
        preArrival: form.preArrival,    // array
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Spirits & Wine" className="h-full w-full object-cover opacity-70" />
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={update("deliveryDateTime")} required
                    />
                  </div>
