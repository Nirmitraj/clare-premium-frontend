// /src/components/travel/ActivitiesModal.jsx
...
const STYLE_OPTIONS = [
  ...
  "Multi Day Tours","Gastronomic Tours","Sightseeing Passes","Other"
];
...
export default function ActivitiesModal({
  ...
  subtitle = "Curated tours, tickets, and day trips",
  imageUrl = "/media/activities.png",
  info = [
    "Cultural, culinary, adventure, and more — tailored to you.",
    "Private guides, small groups, or self-paced with passes.",
    "From must-see landmarks to hidden-gem experiences."
  ],
}) {
  ...
  const updateNum = (name, min = 0) => (e) =>
    setForm(f => ({ ...f, [name]: Math.max(min, parseInt(e.target.value || "0", 10)) }));
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Activities & Experiences" className="h-full w-full object-cover opacity-70" />
            ...
            <div className="p-5 sm:p-6 md:p-7 overflow-y-auto max-h-[54vh] md:max-h-[90vh]">
              {done ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-white/80 mt-1">Your activities enquiry has been submitted. We’ll be in touch soon.</p>
                  <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      maxLength={1000}
                      placeholder="Cultural focus? Early starts? Dietary notes for tastings? Accessibility needs?"
