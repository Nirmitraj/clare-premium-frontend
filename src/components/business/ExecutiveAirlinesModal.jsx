// /src/components/business/ExecutiveAirlinesModal.jsx
...
export default function ExecutiveAirlinesModal({
  open,
  onClose,
  onSubmit,
  title = "Executive Airlines",
  subtitle = "Premium cabins & bespoke itineraries",
  imageUrl = "/media/executive-airlines.png",
  info = [
    "Private-ready service with premium commercial options.",
    "We’ll coordinate transfers, assistance, and special meals.",
    "Share your route, dates, and cabin — we’ll do the rest.",
  ],
}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        transportToHotel: form.transportToHotel,
        wheelchair: form.wheelchair,

        mealRequest: (form.mealRequest || "").slice(0, 100),
        frequentFlyer: form.frequentFlyer.trim(),
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Executive Airlines" className="h-full w-full object-cover opacity-70" />
            ...
            <div className="p-5 sm:p-6 md:p-7 overflow-y-auto max-h-[54vh] md:max-h-[90vh]">
              {done ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-white/80 mt-1">Your executive airlines enquiry has been submitted. We’ll be in touch soon.</p>
                  <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                  ...
                  {/* Trip type */}
                  <div>
                    <label className="block text-sm text-white/85 mb-1">Trip Type</label>
                      ...
                      {TRIP_TYPES.map((opt) => (
                        ...
                        >
                          <input
                            ...
                            checked={form.tripType === opt}
                            onChange={() => setForm((f) => ({ ...f, tripType: opt }))}
                          />
                          {opt}
                        </label>
                      ))}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-sm text-white/85 mb-1">
                        Depart<span className="text-[#ffd369]">*</span>
                      </label>
                      <input
                        type="date"
                    ...
                    <div>
                      <label className="block text-sm text-white/85 mb-1">
                        Return{form.tripType === "Round-Trip" && <span className="text-[#ffd369]">*</span>}
                      </label>
                      <input
                        type="date"
                  ...
                  {/* Meals & FF */}
                  <div>
                    <label className="block text-sm text-white/85 mb-1">Special Meal Requests (max 100 chars)</label>
                    <input
                      type="text"
                      maxLength={100}
                      placeholder="Vegetarian, Kosher, Low sodium, etc."
                      className="w-full rounded-lg bg-white/5 border border-[#b69333]/30 px-3 py-2 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#ffd369]/60"
                  ...
                  <div>
                    ...
                    <textarea
                      maxLength={1000}
                      placeholder="Seat preferences, assistance, connections, celebrations, etc."
