// /src/components/cruises/ShowsModal.jsx
...
// Same lists as Casinos, per your instruction
...
export default function ShowsModal({
  ...
  onSubmit,
  title = "Cruise Shows",
  subtitle = "Onboard entertainment & experiences",
  imageUrl = "/media/cruise-shows.png",
  info = [
    "Reserve main theater productions and headliner shows.",
    "Bundle with dining, beverage packages, and photo add-ons.",
    "We’ll coordinate logistics from port to shore excursions.",
  ],
}) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Cruise Shows" className="h-full w-full object-cover opacity-70" />
            ...
            <div className="p-5 sm:p-6 md:p-7 overflow-y-auto max-h-[54vh] md:max-h-[90vh]">
              {done ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-white/80 mt-1">Your cruise shows enquiry has been submitted. We’ll be in touch soon.</p>
                  <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      maxLength={1000}
                      placeholder="Seating sections, show times, accessibility, celebrations, dietary, etc."
