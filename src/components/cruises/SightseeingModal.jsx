// /src/components/cruises/SightseeingModal.jsx
...
export default function SightseeingModal({
  ...
  onClose,
  onSubmit,
  title = "Cruise Sightseeing",
  subtitle = "Scenic highlights on sea days & in port",
  imageUrl = "/media/cruise-sightseeing.png",
  info = [
    "Plan scenic routes, photo ops, and landmark stops.",
    "Bundle with onboard dining, wellness, and entertainment.",
    "We’ll coordinate timing around port calls and sails.",
  ],
}) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Cruise Sightseeing" className="h-full w-full object-cover opacity-70" />
            ...
            <div className="p-5 sm:p-6 md:p-7 overflow-y-auto max-h-[54vh] md:max-h-[90vh]">
              {done ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-white/80 mt-1">Your cruise sightseeing enquiry has been submitted. We’ll be in touch soon.</p>
                  <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      maxLength={1000}
                      placeholder="Photo stops, scenic routes, mobility needs, dietary, celebrations, etc."
