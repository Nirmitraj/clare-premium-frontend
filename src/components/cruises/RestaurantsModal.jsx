// /src/components/cruises/RestaurantsModal.jsx
...
export default function RestaurantsModal({
  ...
  onClose,
  onSubmit,
  title = "Cruise Restaurants",
  subtitle = "Dining requests with cruise itinerary details",
  imageUrl = "/media/cruise-restaurants.png",
  info = [
    "Request specialty dining, packages, and table preferences.",
    "Bundle with shore experiences and wellness onboard.",
    "We’ll coordinate reservations and logistics for you.",
  ],
}) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Cruise Restaurants" className="h-full w-full object-cover opacity-70" />
            ...
            <div className="p-5 sm:p-6 md:p-7 overflow-y-auto max-h-[54vh] md:max-h-[90vh]">
              {done ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-white/80 mt-1">Your cruise dining enquiry has been submitted. We’ll be in touch soon.</p>
                  <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      maxLength={1000}
                      placeholder="Dietary, table size, celebration notes, accessibility, etc."
