// /src/components/cruises/CasinosModal.jsx
...
export default function CasinosModal({
  open,
  onClose,
  onSubmit,
  title = "Cruise Casinos",
  subtitle = "Gaming, dining, and onboard experiences",
  imageUrl = "/media/cruise-casino.png",
  info = [
    "Casino reservations, tournaments, and host coordination.",
    "Bundle with specialty dining, shows, and beverage packages.",
    "We’ll handle logistics from port to shore experiences.",
  ],
}) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Cruise Casinos" className="h-full w-full object-cover opacity-70" />
            ...
            <div className="p-5 sm:p-6 md:p-7 overflow-y-auto max-h-[54vh] md:max-h-[90vh]">
              {done ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-white/80 mt-1">Your cruise casino enquiry has been submitted. We’ll be in touch soon.</p>
                  <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      maxLength={1000}
                      placeholder="Casino host notes, game preferences, table limits, dietary, accessibility, celebrations, etc."
