// /src/components/concierge/SpecialEventsModal.jsx
...
export default function SpecialEventsModal({
  ...
  subtitle = "VIP access, premieres, and headline moments",
  imageUrl = "/media/special-events.png",
  info = [
    "Premium seats, hospitality, and exclusive access.",
    "Curated logistics — transport, dining, and celebration extras.",
    "We’ll handle the details so you can enjoy the moment.",
  ],
}) {
  ...
  const totalPeople =
    Number(form.adults || 0) + Number(form.children || 0) + Number(form.seniors || 0);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        eventTypeOther: form.eventType === "Other" ? form.eventTypeOther : "",
        eventName: form.eventName.trim(),
        eventDate: form.eventDate,

        adults: Number(form.adults || 0),
        children: Number(form.children || 0),
        seniors: Number(form.seniors || 0),
        people: totalPeople,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Special Events" className="h-full w-full object-cover opacity-70" />
            ...
            <div className="p-5 sm:p-6 md:p-7 overflow-y-auto max-h-[54vh] md:max-h-[90vh]">
              {done ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-white/80 mt-1">Your special event enquiry has been submitted. We’ll be in touch soon.</p>
                  <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    <label className="block text-sm text-white/85 mb-1">
                      Event Type<span className="text-[#ffd369]">*</span>
                    </label>
                      ...
                      {EVENT_TYPES.map((opt) => (
                        ...
                        >
                          <input
                            ...
                            checked={form.eventType === opt}
                            onChange={() => setForm((f) => ({ ...f, eventType: opt }))}
                            required
                          />
                          {opt}
                        </label>
                    ...
                    {form.eventType === "Other" && (
                      <input
                        type="text"
                        placeholder="Tell us the event type"
                        ...
                        onChange={update("eventTypeOther")}
                      />
                    )}
                  </div>
                  ...
                  {/* Event Name */}
                  <div>
                    <label className="block text-sm text-white/85 mb-1">Event Name</label>
                    <input
                      type="text"
                      placeholder="e.g., US Open, Super Bowl, NBA, F1"
                      className="w-full rounded-lg bg-white/5 border border-[#b69333]/30 px-3 py-2 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#ffd369]/60"
                  ...
                  <div>
                    <label className="block text-sm text-white/85 mb-1">
                      Event Date<span className="text-[#ffd369]">*</span>
                    </label>
                    <input
                      type="date"
                  ...
                  {/* People & Ages */}
                  <div>
                    <label className="block text-sm text-white/85 mb-2">People & Ages</label>
                    <div className="grid grid-cols-3 gap-3">
                      <NumberField label="Adults (13–64)" value={form.adults} onChange={updateNum("adults", 0)} />
                    ...
                    <div className="text-xs text-white/70 mt-1">Total: {totalPeople}</div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      maxLength={1000}
                      placeholder="Hospitality suites, player meet & greet, accessibility, celebration notes, etc."
