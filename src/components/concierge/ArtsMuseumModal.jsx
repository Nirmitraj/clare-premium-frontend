// /src/components/concierge/ArtsMuseumModal.jsx
...
export default function ArtsMuseumModal({
  open,
  onClose,
  onSubmit,
  title = "Arts & Museum",
  subtitle = "Curated museum entries, tours & exhibits",
  imageUrl = "/media/arts-museum.png",
  info = [
    "Priority entries and expert-led tours.",
    "VIP passes, transport, and hospitality add-ons.",
    "Perfect for culture lovers and special occasions.",
  ],
}) {
  const [form, setForm] = useState({
    ...
    eventDate: "",  // date
    eventTime: "",  // time (24h or AM/PM; HTML gives 24h)
  ...
  const totalPeople =
    ...
    Number(form.seniors || 0) +
    Number(form.students || 0);

  const valid = form.location.trim() && form.eventDate && totalPeople > 0;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        attraction: form.attraction.trim(),
        eventDate: form.eventDate,
        eventTime: form.eventTime, // optional
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Arts & Museum" className="h-full w-full object-cover opacity-70" />
            ...
            <div className="p-5 sm:p-6 md:p-7 overflow-y-auto max-h-[54vh] md:max-h-[90vh]">
              {done ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-white/80 mt-1">Your arts & museum enquiry has been submitted. We’ll be in touch soon.</p>
                  <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    <label className="block text-sm text-white/85 mb-1">Tourist Attraction</label>
                    <input
                      type="text"
                      placeholder="e.g., Smithsonian, Louvre, MoMA NYC"
                      className="w-full rounded-lg bg-white/5 border border-[#b69333]/30 px-3 py-2 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#ffd369]/60"
                      value={form.attraction}
                      onChange={update("attraction")}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      ...
                      <NumberField label="Students (FT w/ ID)" value={form.students} onChange={updateNum("students", 0)} />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      maxLength={1000}
                      placeholder="Private guide, skip-the-line, gallery focus, accessibility, etc."
