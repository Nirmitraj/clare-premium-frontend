// /src/components/concierge/DestinationEventsModal.jsx
...
export default function DestinationEventsModal({
  open,
  onClose,
  onSubmit,
  title = "Destination Events",
  subtitle = "Weddings, celebrations & milestone gatherings",
  imageUrl = "/media/destination-events.png",
  info = [
    "Venue scouting, vendor coordination, and on-site logistics.",
    "VIP transport, hospitality, and celebration extras.",
    "From intimate vows to large family gatherings.",
  ],
}) {
  ...
  const valid = form.eventLocation.trim() && form.eventDate && form.eventType && form.service;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative h-[36vh] md:h-auto">
              <div className="absolute inset-0">
                <img src={imageUrl} alt="Destination Events" className="h-full w-full object-cover opacity-70" />
            ...
            <div className="p-5 sm:p-6 md:p-7 overflow-y-auto max-h-[54vh] md:max-h-[90vh]">
              {done ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-white/80 mt-1">Your destination event enquiry has been submitted. We’ll be in touch soon.</p>
                  <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    <label className="block text-sm text-white/85 mb-1">
                      Event Location<span className="text-[#ffd369]">*</span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm text-white/85 mb-1">
                      Type of Event<span className="text-[#ffd369]">*</span>
                    </label>
                  ...
                  <div>
                    ...
                    <textarea
                      maxLength={1000}
                      placeholder="Theme, décor, VIPs, accessibility, photography, etc."
                  ...
                  {/* Services (single option) */}
                  <div>
                    <label className="block text-sm text-white/85 mb-1">
                      Services<span className="text-[#ffd369]">*</span>
                    </label>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-white">
                      {SERVICES.map((opt) => (
                        <label
                        ...
                        >
                          <input
                            ...
                            onChange={() => setForm((f) => ({ ...f, service: opt }))}
                            required
                          />
                          {opt}
                        </label>
                    ...
                    {form.service === "Other" && (
                      <input
                        type="text"
                        placeholder="Tell us the service"
                        className="mt-2 w-full rounded-lg bg-white/5 border border-[#b69333]/30 px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-[#ffd369]/60"
